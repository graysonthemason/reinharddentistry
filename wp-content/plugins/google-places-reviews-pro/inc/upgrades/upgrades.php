				...
				jQuery( document ).ready( function () {
					...
					jQuery.post( ajaxurl, data, function ( response ) {
						...
						if ( response == 'complete' ) {
							...
							el_upgrade_status.after( '<div class="updated"><p>Yippee! The upgrade process has completed successfully. Please check your widgets and remember to update your Google Review shortcodes (if you are using any). You will now be redirected back to your previous page.</p></div>' );
