...
<header id="header">
	...
	<div id="topHeader">
		<div class="wrapper">         
			<div class="top_nav">
				<div class="container">					
					<div class="right"><?php $teckzy_image=get_header_image();
					if(! empty($teckzy_image)) { ?>	<img src="<?php header_image(); ?>" height="<?php echo get_custom_header()->height; ?>" width="<?php echo get_custom_header()->width; ?>" alt="teckzy" /><?php } ?>			
			...
			<div class="container">    
				...
				<div class="logo">
					<a href="<?php echo esc_url(home_url( '/' )); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home" id="logo" >
						...
						{ ?>
						<img src="<?php echo esc_url($wl_theme_options['upload_image_logo']); ?>" style="height:<?php if($wl_theme_options['height']!='') { echo esc_attr($wl_theme_options['height']); }  else { "50"; } ?>px; width:<?php if($wl_theme_options['width']!='') { echo esc_attr($wl_theme_options['width']); }  else { "180"; } ?>px;" />
						<?php } else { ?> 
				...
				<div class="menu_main">				
					...
					<div class="container">
							<div class="navbar-header">
								<div class="navbar-toggle .navbar-collapse .pull-right " data-toggle="collapse" data-target="#navbar-collapse-1"  ><span><?php _e('Menu','teckzy');?></span>
