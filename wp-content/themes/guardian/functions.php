...
{	$ImageUrl = get_template_directory_uri() ."/images/invisalign-banner.jpg";
	...
	return $theme_options=array(
			...
			'slide_title' => __('','weblizar'),
			'slide_desc' => __('','weblizar'),
			'slide_btn_text' => __('Read More','weblizar'),
			'slide_btn_link' => '#',
			
			'slide_image_1' => $ImageUrl2,
			'slide_title_1' => __('We Accept All Insurance','weblizar'),
			'slide_desc_1' => __('','weblizar'),
...
//			'slide_btn_link_2' => '#',
			...
			//Social media links
			'contact_email'=>__('info@reinharddentistry.com','weblizar'),
			'contact_phone_no'=>__('1 973 887 2436'),
			'header_section_social_media_enbled'=>'on',
			'footer_section_social_media_enbled'=>'on',
			
			
			//footer customization 
			'footer_customizations' => __('Copyright @ 2015 Reinhard Dentistry.','weblizar'),
	...
	* ==================*/
	...
	{	
		...
		wp_enqueue_style('stylesheet', get_template_directory_uri() . '/css/styles.css');
